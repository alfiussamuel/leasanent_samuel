...
class buku_kasbank(models.TransientModel):
    ...
    def generate_report(self):
        ...
        aml_initial = self.env['account.move.line'].search([('account_id', '=', self.account_id.id),('date', '<', self.date_from),('move_id.state', 'in', status),('company_id', '=', self.company_id.id)])
        ...
        aml = self.env['account.move.line'].search([('account_id', '=', self.account_id.id),('date', '>=', self.date_from),('date', '<=', self.date_to),('move_id.state', 'in', status),('company_id', '=', self.company_id.id)])
        ...
        form_res = ir_model_data.get_object_reference(
            'an_buku_kasbank_report_lea', 'report_buku_kasbank_wizard')
