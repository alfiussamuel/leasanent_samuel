...
class VoucherVoucher(models.Model):
	...
	def create(self, vals):
		...
		if vals['voucher_value'] < default_values['min_amount']:
			raise  ValidationError(('You can`t create voucher below this minimum amount (%s) !!!')%default_values['min_amount'])
		if vals['voucher_value'] > default_values['max_amount']:
			raise  ValidationError(('You can`t create voucher greater than this maximum amount (%s) !!!')%default_values['max_amount'])
