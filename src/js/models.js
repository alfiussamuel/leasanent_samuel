...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        fields: ['display_name', 'list_price','price','pos_categ_id', 'taxes_id', 'barcode', 'default_code', 
                 'to_weight', 'uom_id', 'description_sale', 'description', 'product_desc',
...
exports.Orderline = Backbone.Model.extend({
    ...
    get_discount_amount: function(){
  	return this.discount * this.get_unit_price() / 100 * this.get_quantity();
    },
    ...
    //get_product_desc: function(){
    //	return this.product.product_tmpl_id[0].product_desc;
    //}
