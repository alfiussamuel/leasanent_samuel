...
class WizardSummarySalesPerformanceChannel(models.TransientModel):
    _name = "wizard.summary.sales.performance.channel"
    _description = "Summary Sales Performance per Channel"
    ...
    class_category_id       = fields.Many2many('lea.product.moving.status', 'summary_report_class_rel', 'report_id', 'class_id', string='Class Category')
    ...
    def print_report(self):
        ...
        data = {
            ...
            'class_category_id'         : self.class_category_id.ids,
        ...
        return self.env['report'].get_action([], 'v10_lea.report_summary_sales_performance_channel',data=data)