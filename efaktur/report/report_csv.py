    ...
    def create(self, cr, uid, ids, data, context=None):
        ...
        if report.ids:
            ...
            if report.report_type == 'csv':
                return self.create_source_csv(ids, data, report)
...
#                 ) % self.hf_params,
        ...
        self.generate_csv_report(_p, _xs, data, objs, wb)
    ...
    def generate_csv_report(self, parser, xls_styles, data, objects, wb):
